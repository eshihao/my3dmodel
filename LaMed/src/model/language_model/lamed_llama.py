    ...
    def forward(
        ...
        if self.get_model().seg_enable and seg_ids:
            ...
            return super().forward(
                ...
                attention_mask=attention_mask,  # b 512
                position_ids=position_ids,  # None
                past_key_values=past_key_values,  # None
                inputs_embeds=inputs_embeds,  # b 512 4096
                labels=labels,  # b 512
        ...
        **kwargs,
        ...
        if seg_enable:
            ...
            output_ids = super().generate(
                inputs_embeds=inputs_embeds,  # 1 298 4096
                attention_mask=attention_mask,  # 1 298
                # return_dict=True,
                # use_cache=True,
                **kwargs  # {'max_new_tokens': 256, 'do_sample': False, 'top_p': None, 'temperature': 1.0, 'pad_token_id': 128001, 'eos_token_id': 128001}
            )
            return output_ids
