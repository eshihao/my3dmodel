...
class ViT_stage2(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.sga_adapter = nn.Linear(512, hidden_size)
        self.kd_proj = nn.Linear(hidden_size, 512)
    ...
    def forward(self, x, slice_features=None, **kwargs):
        ...
        if slice_features is not None:
            ...
            slice_features_768 = self.sga_adapter(slice_features)
            f_fused, att_map = self.sga(f_3d_raw, slice_features_768)
...
class ViT3DTower_dual_encoders(nn.Module):
    ...
    def forward(self, images, images_2d):
        ...
        image_features_stage2 = hidden_states_stage2
